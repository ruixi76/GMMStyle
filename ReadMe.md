...
```bash
# 仅像素级风格迁移
python main.py --source_domain amazon --target_domain dslr --style_mode pixel --lambda_pixel 1.0 --auto_select_k --bic_k_candidates 1,3,5,7,9 --bic_num_batches 1 --bic_em_iters 15
